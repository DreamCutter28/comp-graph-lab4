                   ...
                   int nCmdShow)
{
    ...
    {
        // x1   // x2   // y1   // y2
        0.0f,  0.0f, -100.0f,   900.0f, //Левый край экрана
        1024.0f,  1024.0f, -100.0f,   900.0f, //Правый край экрана
        0.0f,  1024.0f, 0.0f,   355.0f, //Пол
        100.0f,  235.0f, 355.0f,   435.0f, //Здание, нижняя часть
        100.0f,  220.0f, 435.0f,   510.0f, //Здание, верхняя часть
        305.0f,  420.0f, 355.0f,   435.0f, //Алтарь
        900.0f,  970.0f, 355.0f,   485.0f, //Башня
        0.0f,  1024.0f, 0.0f,   355.0f //Пол
    };

    //Инициализация персонажей
    Character* mainCharacter = createCharacter(0.0f, 650.0f, spriteSheet, 3, 8);
    addVelocity(mainCharacter, 50, 0);                                              //Крутое появление из за края экрана!
