...
int WINDOW_HEIGHT = 768; // Костыль всех времен (ориентация пространства для отрисовки конкретного персонажа)
...
void playerControl (Character *ch)          //Управление персонажем
{
    if (ch->inAir)
    {
